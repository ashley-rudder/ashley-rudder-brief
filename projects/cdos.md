...
Sharpened the same evening: Christian is Poppy staff; Charan is an outside vendor Poppy brought in when Christian was unavailable (per Ashley, to be confirmed against her recordings along with the date Athena said she would get Christian on it). The leverage stack once the date is pulled: Athena assigns Christian, Poppy staff, on [date]; Christian unavailable, Poppy procures Charan at its own initiative and cost; the July 31 packet prices that same work at $6,500; Option 1 today excludes it entirely. A commitment does not get staffed internally, then subcontracted externally, unless it was owed. Ashley's ask is person-agnostic on purpose: a launch strategist and the Poppy boards, whoever fills the chair.
